...
module.exports = {
    ...
    JWTAdminSign : function(user_id, username, role, permission_id,csrf_token){
        var token = jwt.sign({ _i: user_id, _u:username,_role: role, _pid: permission_id, csrf : csrf_token }, JWT_KEY, { expiresIn :'24h'});
        return token;
    },
